...
namespace Create_wireframe_contour_surface_chart
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (WordDocument document = new WordDocument())
            {
                ...
                //Set chart type.
                chart.ChartType = OfficeChartType.Surface_NoColor_Contour;
                //Set chart series in the column for assigned data region.
                chart.IsSeriesInRows = false;
                //Set a Chart Title.
                chart.ChartTitle = "Wireframe Contour Surface Chart";
                //Set legend.
