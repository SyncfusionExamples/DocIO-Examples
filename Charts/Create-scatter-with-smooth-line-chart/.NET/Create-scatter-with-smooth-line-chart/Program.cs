...
namespace Create_scatter_with_smooth_line_chart
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (WordDocument document = new WordDocument())
            {
                ...
                //Set chart type.
                chart.ChartType = OfficeChartType.Scatter_SmoothedLine;
                //Set chart data.
                ...
                //Set a Chart Title.
                chart.ChartTitle = "Scatter line with smooth line Chart";
                //Set Datalabels.
