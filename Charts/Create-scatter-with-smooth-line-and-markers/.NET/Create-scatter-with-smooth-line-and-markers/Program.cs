...
namespace Create_scatter_with_smooth_line_and_markers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (WordDocument document = new WordDocument())
            {
                ...
                //Set chart type.
                chart.ChartType = OfficeChartType.Scatter_SmoothedLine_Markers;
                //Set chart data.
                ...
                //Set a Chart Title.
                chart.ChartTitle = "Scatter with smooth line and markers Chart";
                //Set Datalabels.
