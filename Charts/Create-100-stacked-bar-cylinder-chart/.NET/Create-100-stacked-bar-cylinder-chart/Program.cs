...
namespace Create_100_stacked_bar_cylinder_chart
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (WordDocument document = new WordDocument())
            {
                ...
                //Set a Chart Title.
                chart.ChartTitle = "100% Stacked Bar Cylinder Chart";
                //Set Datalabels.
                ...
                //Set chart type.
                chart.ChartType = OfficeChartType.Cylinder_Bar_Stacked_100;
