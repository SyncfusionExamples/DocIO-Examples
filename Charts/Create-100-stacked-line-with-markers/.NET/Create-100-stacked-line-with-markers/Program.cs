...
namespace Create_100_stacked_line_with_markers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (WordDocument document = new WordDocument())
            {
                ...
                //Set chart type.
                chart.ChartType = OfficeChartType.Line_Markers_Stacked_100;
                //Set chart data.
                ...
                //Set a Chart Title.
                chart.ChartTitle = "100% Stacked Line with Markers Chart";
                //Set Datalabels.
                ...
                series1.DataPoints.DefaultDataPoint.DataLabels.Position = OfficeDataLabelPosition.Left;
                series2.DataPoints.DefaultDataPoint.DataLabels.Position = OfficeDataLabelPosition.Left;
                series3.DataPoints.DefaultDataPoint.DataLabels.Position = OfficeDataLabelPosition.Left;
                //Set legend.
