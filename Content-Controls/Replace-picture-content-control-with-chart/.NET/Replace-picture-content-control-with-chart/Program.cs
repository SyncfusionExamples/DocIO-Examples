...
using (FileStream docStream = new FileStream(Path.GetFullPath(@"../../../Data/PictureContentControl_InputDocument.docx"), FileMode.Open))
{
    ...
    using (WordDocument document = new WordDocument(docStream, Syncfusion.DocIO.FormatType.Automatic))
    {
        ...
        using (FileStream outputFileStream = new FileStream(Path.GetFullPath(@"../../../Data/ReplacedPictureContentControl.docx"), FileMode.Create, FileAccess.ReadWrite))
        {
